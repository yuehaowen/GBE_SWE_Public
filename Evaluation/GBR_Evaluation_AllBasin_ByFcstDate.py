# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 10:48:27 2025

@author: yue0004
"""

# This is the Python script to evaluate the results from GBR model trained by data from all basins by forecast data
...
def combine_fold_results(site_id, issue_date, swe_ind):
    ...
    directory = f'{Root_Dir}/results_allbasin_bydate/{swe_ind}'
    ...
    output_directory = f'{Root_Dir}/results_allbasin_bydate/4fold_combined_{swe_ind}'
...
for site in site_id_short_in_monthlyNSF:
    ...
    for date in forecast_date:
        # import GBR results
        # import GBR with SWE
        result_df_withswe = pd.read_csv('E:/USBR_Snow_Forecast/Fcst_Model/results_allbasin_bydate/4fold_combined_with_SWE/%s_%s.csv' % (site, date))
        result_df_withswe['issue_date'] = date
        # import GBR without SWE
        result_df_woswe = pd.read_csv('E:/USBR_Snow_Forecast/Fcst_Model/results_allbasin_bydate/4fold_combined_without_SWE/%s_%s.csv' % (site, date))
...
mean_QL_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_QL_withSWE_all.csv', index=False)
# NSE with SWE
mean_NSE_df_all_withswe = pd.concat(mean_NSE_df_withswe_list, axis=0, ignore_index=True)
mean_NSE_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_NSE_withSWE_all.csv', index=False)
# # RMSE with SWE
# mean_RMSE_df_all_withswe = pd.concat(mean_RMSE_df_withswe_list, axis=0, ignore_index=True)
# mean_RMSE_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_RMSE_withSWE_all.csv', index=False)
# NRMSE with SWE
mean_NRMSE_df_all_withswe = pd.concat(mean_NRMSE_df_withswe_list, axis=0, ignore_index=True)
mean_NRMSE_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_NRMSE_withSWE_all.csv', index=False)
# # RPSS with SWE
# mean_RPSS_df_all_withswe = pd.concat(mean_RPSS_df_withswe_list, axis=0, ignore_index=True)
# mean_RPSS_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_RPSS_withSWE_all.csv', index=False)
# Interval coverage with SWE
mean_IC_df_all_withswe = pd.concat(mean_IC_df_withswe_list, axis=0, ignore_index=True)
mean_IC_df_all_withswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_IC_withSWE_all.csv', index=False)

# QL without SWE
mean_QL_df_all_woswe = pd.concat(mean_QL_df_woswe_list, axis=0, ignore_index=True)
mean_QL_df_all_woswe.to_csv(Root_Dir + '/results_allbasin_bydate/mean_QL_withoutSWE_all.csv', index=False)
# NSE without SWE
mean_NSE_df_all_woswe = pd.concat(mean_NSE_df_woswe_list, axis=0, ignore_index=True)
mean_NSE_df_all_woswe.to_csv(Root_Dir + '/results_allbasin_bydate/mean_NSE_withoutSWE_all.csv', index=False)
# # RMSE without SWE
# mean_RMSE_df_all_woswe = pd.concat(mean_RMSE_df_woswe_list, axis=0, ignore_index=True)
# mean_RMSE_df_all_woswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_RMSE_withoutSWE_all.csv', index=False)
# NRMSE without SWE
mean_NRMSE_df_all_woswe = pd.concat(mean_NRMSE_df_woswe_list, axis=0, ignore_index=True)
mean_NRMSE_df_all_woswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_NRMSE_withoutSWE_all.csv', index=False)
# # RPSS without SWE
# mean_RPSS_df_all_woswe = pd.concat(mean_RPSS_df_woswe_list, axis=0, ignore_index=True)
# mean_RPSS_df_all_woswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_RPSS_withoutSWE_all.csv', index=False)
# Interval coverage without SWE
mean_IC_df_all_woswe = pd.concat(mean_IC_df_woswe_list, axis=0, ignore_index=True)
mean_IC_df_all_woswe.to_csv(Root_Dir +'/results_allbasin_bydate/mean_IC_withoutSWE_all.csv', index=False)
...
for patch in legend.get_patches():
    patch.set_alpha(0.5)
plt.savefig(Root_Dir + '/figures/boxplot_combined_QL_allbasin.png', dpi=600)
...
for patch in legend.get_patches():
    patch.set_alpha(0.5)
plt.savefig(Root_Dir + '/figures/boxplot_combined_NSE_allbasin.png', dpi=600)
...
for patch in legend.get_patches():
    patch.set_alpha(0.5)
plt.savefig(Root_Dir + '/figures/boxplot_combined_RMSE.png', dpi=600)
...
for patch in legend.get_patches():
    patch.set_alpha(0.5)
plt.savefig(Root_Dir + '/figures/boxplot_combined_NRMSE.png', dpi=600)
...
for patch in legend.get_patches():
    patch.set_alpha(0.5)
plt.savefig(Root_Dir + '/figures/boxplot_combined_RPSS.png', dpi=600)
