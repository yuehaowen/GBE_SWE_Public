# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 12:17:43 2025

@author: yue0004
"""

# This is the Python script to plot the evaluation metrix of model training using all forecast sites all issue date
...
# QL with SWE
mean_QL_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_QL_withSWE_all.csv')
# NSE with SWE
mean_NSE_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_NSE_withSWE_all.csv')
# # RMSE with SWE
# mean_RMSE_df_all_withswe = pd.read_csv('E:/USBR_Snow_Forecast/Results/mean_RMSE_withSWE_all.csv')
# NRMSE with SWE
mean_NRMSE_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_NRMSE_withSWE_all.csv')
# interval coverage
mean_IC_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_IC_withSWE_all.csv')
# covert value to percent
mean_IC_df_all_withswe['IC'] = mean_IC_df_all_withswe['IC'] * 100
# Extract evaluation metrics from GBR-NoSWE
# QL without SWE
mean_QL_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_QL_withoutSWE_all.csv')
# # QL, all quantiles, without SWE
# mean_AllQL_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_QL_AllQ_withoutSWE_all.csv')
# NSE without SWE
mean_NSE_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_NSE_withoutSWE_all.csv')
# # RMSE without SWE
# mean_RMSE_df_all_woswe = pd.read_csv('E:/USBR_Snow_Forecast/Results/mean_RMSE_withoutSWE_all.csv')
# NRMSE without SWE
mean_NRMSE_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_NRMSE_withoutSWE_all.csv')
# interval coverage
mean_IC_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_alldate/mean_IC_withoutSWE_all.csv')
# covert value to percent
...
# # QL without SWE
# mean_QL_df_all_climo = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_QL_climo_all.csv')
# # QL, all quantiles, without SWE
# mean_AllQL_df_all_climo = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_QL_AllQ_climo_all.csv')
# # NSE without SWE
# mean_NSE_df_all_climo = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NSE_climo_all.csv')
# # NRMSE without SWE
# mean_NRMSE_df_all_climo = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NRMSE_climo_all.csv')
# # interval coverage
# mean_IC_df_all_climo = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_IC_climo_all.csv')
# # covert value to percent
...
QL_df_forplot = pd.concat([mean_QL_df_all_withswe, mean_QL_df_all_woswe])
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_QL_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_QL_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_QL_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
# Combine the datasets into one DataFrame for side-by-side plotting
NSE_df_forplot = pd.concat([mean_NSE_df_all_withswe, mean_NSE_df_all_woswe])
# # Set the color palette for the plot
palette = {
    'With SWE': '#619CFF',  # Light blue
    'Without SWE': '#F8766D',  # Red
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NSE_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NSE_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NSE_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
# Combine the datasets into one DataFrame for side-by-side plotting
NRMSE_df_forplot = pd.concat([mean_NRMSE_df_all_withswe, mean_NRMSE_df_all_woswe])
# # Set the color palette for the plot
palette = {
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NRMSE_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NRMSE_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_NRMSE_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
# Combine the datasets into one DataFrame for side-by-side plotting
IC_df_forplot = pd.concat([mean_IC_df_all_withswe, mean_IC_df_all_woswe])
# # Set the color palette for the plot
palette = {
    'With SWE': '#619CFF',  # Light blue in R ggplot
    'Without SWE': '#F8766D',  # Red in R ggplot
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_IC_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_IC_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_alldate_IC_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
