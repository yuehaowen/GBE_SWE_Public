# -*- coding: utf-8 -*-
"""
Created on Tue Jan 21 17:13:22 2025

@author: yue0004
"""

# This is the R script to calculate the confidence interval and the number of times the observation is within the CI
# The script is adapted from the Evaluation scripts for all error metrics
...
mean_IC_df_all_withswe.to_csv(src_dir + '/results_single_basin_1982_2021/mean_IC_withSWE_all.csv', index=False)

# Intercal coverage without SWE
mean_IC_df_all_woswe = pd.concat(mean_IC_df_woswe_list, axis=0, ignore_index=True)
mean_IC_df_all_woswe.to_csv(src_dir + '/results_single_basin_1982_2021/mean_IC_withoutSWE_all.csv', index=False)
