# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 10:13:00 2025

@author: yue0004
"""

# This is the Python script to plot the evaluation metrix of model training using all forecast sites by forecast issue date
...
# QL with SWE
mean_QL_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_QL_withSWE_all.csv')
# NSE with SWE
mean_NSE_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NSE_withSWE_all.csv')
# # RMSE with SWE
# mean_RMSE_df_all_withswe = pd.read_csv('E:/USBR_Snow_Forecast/Results/mean_RMSE_withSWE_all.csv')
# NRMSE with SWE
mean_NRMSE_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NRMSE_withSWE_all.csv')
# interval coverage
mean_IC_df_all_withswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_IC_withSWE_all.csv')
# covert value to percent
mean_IC_df_all_withswe['IC'] = mean_IC_df_all_withswe['IC'] * 100
# Extract evaluation metrics from GBR-NoSWE
# QL without SWE
mean_QL_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_QL_withoutSWE_all.csv')
...
# NSE without SWE
mean_NSE_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NSE_withoutSWE_all.csv')
# # RMSE without SWE
# mean_RMSE_df_all_woswe = pd.read_csv('E:/USBR_Snow_Forecast/Results/mean_RMSE_withoutSWE_all.csv')
# NRMSE without SWE
mean_NRMSE_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_NRMSE_withoutSWE_all.csv')
# interval coverage
mean_IC_df_all_woswe = pd.read_csv(src_dir + '/results_allbasin_bydate/mean_IC_withoutSWE_all.csv')
# covert value to percent
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_QL_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_QL_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_QL_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NSE_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NSE_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NSE_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NRMSE_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NRMSE_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_NRMSE_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
...
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_IC_nolegend.png', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_IC_nolegend.pdf', format='pdf', dpi=600)
plt.savefig('E:/USBR_Snow_Forecast/Figure/boxplot_allbasin_bydate_IC_nolegend.eps',format='eps', dpi=600)
# Show the plot
plt.show()
