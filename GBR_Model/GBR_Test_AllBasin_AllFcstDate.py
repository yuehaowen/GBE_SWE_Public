# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 09:15:11 2025

@author: yue0004
"""

# This is the Python script to test the GBR model trained by all data, all basin all forecast dates
    ...
    for site in site_id_short_in_monthlyNSF:  # TODO 22 sites
        ...
        for fold_name, fold in folds:
            ...
            for SWE_ind in SWE_flags:
                if SWE_ind == 'SWE':
                    model_10_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/with_SWE/',
                                                 f"AllSite_AllDate_0.1_{fold_name}_model.dat")
                    model_30_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/with_SWE/',
                                                 f"AllSite_AllDate_0.3_{fold_name}_model.dat")
                    model_50_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/with_SWE/',
                                                 f"AllSite_AllDate_0.5_{fold_name}_model.dat")
                    model_70_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/with_SWE/',
                                                 f"AllSite_AllDate_0.7_{fold_name}_model.dat")
                    model_90_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/with_SWE/',
                                                 f"AllSite_AllDate_0.9_{fold_name}_model.dat")
                elif SWE_ind == 'noSWE':
                    model_10_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/without_SWE/',
                                                 f"AllSite_AllDate_0.1_{fold_name}_model.dat")
                    model_30_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/without_SWE/',
                                                 f"AllSite_AllDate_0.3_{fold_name}_model.dat")
                    model_50_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/without_SWE/',
                                                 f"AllSite_AllDate_0.5_{fold_name}_model.dat")
                    model_70_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/without_SWE/',
                                                 f"AllSite_AllDate_0.7_{fold_name}_model.dat")
                    model_90_path = os.path.join('E:/USBR_Snow_Forecast/Fcst_Model/Results_Temp/all_basin_all_date/without_SWE/',
                                                 f"AllSite_AllDate_0.9_{fold_name}_model.dat")
                ...
                if save_test_results:
                    if SWE_ind == 'SWE':
                        df_test_result.to_csv(
                            'E:/USBR_Snow_Forecast/Fcst_Model/results_allbasin_alldate/with_SWE/%s_%s_%s.csv' % (site, date, fold_name),
                            index=False)
                    elif SWE_ind == 'noSWE':
                        df_test_result.to_csv(
                            'E:/USBR_Snow_Forecast/Fcst_Model/results_allbasin_alldate/without_SWE/%s_%s_%s.csv' % (site, date, fold_name),
                            index=False)
