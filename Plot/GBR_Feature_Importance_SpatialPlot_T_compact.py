# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 16:50:55 2025

@author: yue0004
"""

# This is the Python script to plot the spatial map of feature importance of Temperature in a compact layout
...
FI_df_withswe = FI_df_withswe_all[(FI_df_withswe_all['quantile']=='50%') & (FI_df_withswe_all['feature']=='T')]
...
for issue_date in forecast_date:
    ...
    plt.savefig(f'E:/USBR_Snow_Forecast/Figure/Spatial/FI/FI_map_T_withSWE_allcategories_{issue_date}.png', dpi=600, bbox_inches='tight')
    plt.savefig(f'E:/USBR_Snow_Forecast/Figure/Spatial/FI/FI_map_T_withSWE_allcategories_{issue_date}.eps', format='eps', dpi=600, bbox_inches='tight')
    plt.close()
...
# extract results for 50% quantile
FI_df_woswe = FI_df_woswe_all[(FI_df_woswe_all['quantile']=='50%') & (FI_df_woswe_all['feature']=='T')]
# Define marker styles for each category
marker_styles = {
    'low': 'o',  # Circle for low flow
    'mid': '^',  # Triangle for mid flow
...
for issue_date in forecast_date:
    ...
    # Set title and save the plot
    plt.title(f'NSE Feature Importance - Issue Date {issue_date}')
    plt.savefig(f'E:/USBR_Snow_Forecast/Figure/Spatial/FI/FI_map_T_withoutSWE_allcategories_{issue_date}.png', dpi=600, bbox_inches='tight')
    plt.savefig(f'E:/USBR_Snow_Forecast/Figure/Spatial/FI/FI_map_T_withoutSWE_allcategories_{issue_date}.eps', format='eps', dpi=600, bbox_inches='tight')
    plt.close()
